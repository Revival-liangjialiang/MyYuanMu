...
public class PercentLayoutHelper
{
    ...
    /**
     * Iterates over children and changes their width and height to fragment_lifecircle calculated from percentage
     * values.
     *
     ...
     *
     * @return True if the measure phase needs to be rerun because fragment_lifecircle of the children would like
